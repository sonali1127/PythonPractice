...
'''
'''
obj.__dict__ tells us about the attributes of the object in the form of dictionary
help() :- tells us about the total keyword
__len__(self):len(obj)
__str__(self)/__repr__(self)-accessed by an object
